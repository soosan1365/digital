...
const StoreCard = ({ name, rating, price, imgSrc }: PRODUCT) => {
  return (
    <div className="relative flex flex-col justify-between items-center shadow-black/15 shadow-lg
     dark:shadow-white/35 bg-gray-50 dark:bg-gradient-to-b text-gray-800 from-[#cff7d8] to-[#f4f7f8] rounded-2xl">
